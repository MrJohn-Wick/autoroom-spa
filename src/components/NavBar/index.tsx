...
import { MainMenuStyled, MenuItemHasChildrenStyled, MenuListStyled, NavBarStyled, SubMenuStyled } from './styled';
  ...
  return (
    <NavBarStyled className={`${state.scrollY > 10 ?"sticky":""} header-area style-5`}>
      <MainMenuStyled className={`main-menu ${state.isSidebarOpen ? "show-menu" : ""}`}>
        <MenuListStyled>
          <MenuItemHasChildrenStyled className={`menu-item-has-children ${ currentRoute === "/" ? "active" : ""}`}>
            <a>Главная</a>
            <SubMenuStyled className={`sub-menu ${ state.activeMenu === "home-one" ? "d-block" : ""}`}>
              <li><Link to="/">Home 01</Link></li>
              <li><Link to="/index2">Home 02</Link></li>
              <li><Link to="/index3">Home 03</Link></li>
              <li><Link to="/index4">Home 04</Link></li>
              <li><Link to="/index5">Home 05</Link></li>
              <li><Link to="/index6">Home 06</Link></li>
            </SubMenuStyled>
      ...
      <div className="nav-right d-flex jsutify-content-end align-items-center">
        <Button data-bs-toggle="modal" data-bs-target="#signUpModal01">
